...
label = cnt.index
counts = h_rated['Number Of Ratings']
fig = px.bar(h_rated, x = label, y = counts, title = "Number of ratings for highest Rated Iphones")
fig.show()

# << DA : Apple Iphone 8 Plus Gold 64GB has the highest number of ratings
